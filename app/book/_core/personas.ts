...
export const v5_PERSONAS: Record<FragmentPersonaId, PersonaDefinition> = {
  Ash: {
    id: 'Ash',
    name: 'Ash',
    lens: '逻辑、因果、模式、误差、系统',
...
export function routePersonaForFragment(original: string): FragmentPersonaId {
  ...
  let bestScore = 0;
  for (const persona of Object.keys(v5_PERSONAS) as FragmentPersonaId[]) {
